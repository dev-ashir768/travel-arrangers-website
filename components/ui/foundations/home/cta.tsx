...
const CTA = () => {
  return (
    <section className='container mx-auto px-4 lg-px-6 py-16 lg:py-20'>
      <div className="bg-gradient-to-br from-primary to-red-600 rounded-3xl p-12 text-center text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex justify-center">
            <Button className='sm:w-[166px] w-full' variant="secondary" size="lg">Contact</Button>
          </div>
        </div>

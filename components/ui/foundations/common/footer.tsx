        ...
        <div className='container mx-auto px-4 lg:px-6'>
          ...
          <div className="border-b border-muted-foreground">
            <div className="text-center lg:py-12 py-8">
              <h3 className="lg:text-3xl text-2xl font-bold mb-4">Stay Updated with Travel Deals</h3>
              ...
              <div className="flex flex-col max-w-sm mx-auto">
                <div className='flex justify-between items-center gap-4 pl-4 pr-3 py-1.5 bg-white/10 border border-muted-foreground rounded-md'>
                  <Input type="email" className='group bg-transparent border-0 focus:ring-0 h-full p-0 rounded-none focus-visible:ring-0 text-primary-foreground placeholder:text-primary-foreground' placeholder="Enter your email address" />
                  <Tooltip>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-3">
                  <Link href="#" className="flex items-center space-x-3 footer-nav-link w-max">
                  ...
                  <Link href="#" className="flex items-start space-x-3 footer-nav-link w-max">
              ...
              {Object.entries(FooterLinksData).map(([category, links]) => (
                <div key={category}>
                  ...
                  <ul className="space-y-3">
                    {links.map((link) => (
                      <li key={link}>
                        <Link href="#" className="footer-nav-link">{link}</Link>
                      </li>
                    ))}
                  </ul>
                </div>
